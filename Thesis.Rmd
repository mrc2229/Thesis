...
* Run again and make two models with dinker and binge

# This entire section is not making sense to me. Can't get list to unlist in a way that can be usable. Do have all the weights however.
...
# this part is just not working at all until above is fixed: plot(ps, type="jitter")
```
