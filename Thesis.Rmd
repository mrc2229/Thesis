...
outcome_fun_1 = function(y) {
outcome_lm_1 = glm(apnea ~ bmi + race + martstat + binge_drinker, family = binomial(logit), data=z, weights= y)
}
...
?GLM will give more information needed, can use lapply too to go accross each

Use MICombine on these GLM results to get more familiar output. ?MICombine for more. 
