...
# this part is just not working at all until above is fixed: plot(prop_score, type="jitter")
```

# Grab matched data - weights
## None of this is working at all, but may have done this with do.call and rbind?
